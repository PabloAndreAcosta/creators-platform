...
/** Creator tooling grid — moved off the home page; lives on /for-kreatorer. */
          ...
          {FEATURES.map((f) => (
            <div
              ...
              className={`relative rounded-2xl border bg-[var(--usha-card)] p-5 transition ${
                f.isNew ? "border-[var(--usha-gold)]/40" : "border-[var(--usha-border)] hover:border-[var(--usha-gold)]/30"
              }`}
            >
              {f.isNew && (
