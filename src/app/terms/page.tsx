      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-[var(--usha-muted)]">
          <section>
            ...
            <p>
              Dessa användarvillkor (&ldquo;Villkor&rdquo;) reglerar din användning av Usha Platform-plattformen
              (&ldquo;Plattformen&rdquo;) som tillhandahålls av Usha AB, med säte i
              Malmö, Sverige (&ldquo;Usha Platform&rdquo;, &ldquo;vi&rdquo;, &ldquo;oss&rdquo;). Genom att skapa ett konto eller använda
          ...
          <section>
            ...
            <p>
              Usha Platform är en marknadsplats som kopplar samman kreatörer, upplevelseleverantörer
              och kunder. Plattformen gör det möjligt att publicera tjänster, boka upplevelser
              och genomföra betalningar. Usha Platform agerar som förmedlare och är inte part i avtal
          ...
          <section>
            ...
            <p>
              ...
              Usha Platform förbehåller sig rätten att avsluta konton som bryter mot dessa Villkor.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              även Stripes tjänstevillkor. Usha Platform tar en provision på transaktioner enligt den
          ...
          <section>
            ...
            <p>
              ...
              bestäms av kreatören för varje enskild tjänst. Usha Platform ansvarar inte för
          ...
          <section>
            ...
            <p>
              ...
              publicera innehåll på Plattformen ger du Usha Platform en icke-exklusiv rätt att visa
          ...
          <section>
            ...
            <p>
              Usha Platform tillhandahåller Plattformen &ldquo;som den är&rdquo; utan garantier av något slag.
              Vi ansvarar inte för indirekta skador, utebliven vinst eller förlust av data.
              Vårt totala ansvar är begränsat till det belopp du har betalat till Usha Platform under
          ...
          <section>
            ...
            <p>
              Usha Platform förbehåller sig rätten att ändra dessa Villkor. Väsentliga ändringar
